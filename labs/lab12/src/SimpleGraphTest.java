...
public class SimpleGraphTest {
    ...
    public static GraphInterface<Integer> setUp() {
        GraphInterface<Integer> testGraph = new SimpleGraph();
        for (int i = 1; i < 10; i++) {
    ...
    public static void searchTest(GraphInterface<Integer> testGraph) {
        Queue<VertexInterface<Integer>> testGraphSearch = testGraph.depthFirstSearchIterative(1);
        for (VertexInterface<Integer> integer : testGraphSearch) {
            System.out.print(integer.getLabel() + "-");
        }
    }

    public static void main(String[] args) {
        GraphInterface<Integer> testGraph = setUp();
        searchTest(testGraph);
    }
